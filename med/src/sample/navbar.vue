<template>
  <div>
    <v-app-bar app color="light-blue lighten-2" flat white_text>
      ...
      <v-tabs v-if="(roles == 'biller')" centered class="ml-n9" color="white--text">
        <!-- Biller -->
      ...
      <v-tabs v-if="(roles== 'inventory')" centered class="ml-n9" color="white--text">
        <!-- Inventory -->
        <v-tab @click="dashboardfunction()">
          Dashboard
        </v-tab>
      ...
      </v-tabs> <v-tabs v-if="roles == 'manager'" centered class="ml-n9" color="white--text">
        <!-- Manager -->
        <v-tab @click="dashboardfunction()">
          Dashboard
        </v-tab>
      ...
      </v-tabs> <v-tabs v-if="roles == 'admin'" centered class="ml-n9" color="white--text">
        <!-- System Admin -->
        <v-tab @click="dashboardfunction()">
          Dashboard
        </v-tab>
